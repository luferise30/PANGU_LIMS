...
END
	...
	else
	{
		...
		if($checkAsbProjectName->rows < 1)
		{
			#my $insertAsbProject=$dbh->prepare("INSERT INTO matrix VALUES (0, 'asbProject', ?, '', 1, 1, 1, 0, ?, ?, NOW())");
			my $insertAsbProject=$dbh->prepare("INSERT INTO matrix VALUES (NULL, 'asbProject', ?, 0, 1, 1, 1, 0, ?, ?, NOW())");
