...
open (TAB,">$tmpdir/genotypeComparison.$$.txt") or die "can't open file: $tmpdir/genotypeComparison.$$.txt";
my $genotypes = "";
my $firstLine = '';
my $secondLine = '';
my $genotypeTabLine = "";
...
close (TAB);
`gzip -f $tmpdir/genotypeComparison.$$.txt`;

open (COMPARISON,">$tmpdir/genotypeComparison.$$.html") or die "can't open file: $tmpdir/genotypeComparison.$$.html";
print COMPARISON "<table width='100%'>\n$genotypes\n</table>";
close (COMPARISON);
`gzip -f $tmpdir/genotypeComparison.$$.html`;
...
$( "#dialog" ).dialog( "option", "buttons", [ { text: "Text", click: function() { location.href='$tempurl/genotypeComparison.$$.txt.gz'; } }, { text: "HTML", click: function() { location.href='$tempurl/genotypeComparison.$$.html.gz'; } }, { text: "Print", click: function() {printDiv('genotypeComparison$$'); } }, { text: "OK", click: function() {closeDialog(); } } ] );
</script>
HTML
return $data;}
