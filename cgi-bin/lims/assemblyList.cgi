...
if ($assemblyId)
{
	...
	my $gapFillerViewer = '';
	$gapFillerViewer = "<li><a onclick='openDialog(\"$tempurl/$assemblyId.gapfill.html\")'><span class='ui-icon ui-icon-bullet'></span>View</a></li>" if (-e "$tmpdir/$assemblyId.gapfill.html");
	my $gapFillerDownload = '';
	$gapFillerDownload = "<li><a href='$tempurl/$assemblyId.gapfill.txt.gz' target='hiddenFrame'><span class='ui-icon ui-icon-bullet'></span>Download</a></li>" if (-e "$tmpdir/$assemblyId.gapfill.txt.gz");
