...
# 	$refGenomeSequence[8] =~ s/"sequence":"(.*?)",//g; #here is the trick, to get sequence from JSON string in case of sequence is too long to effect decode_json
	...
	open (SVGFILE,">$tmpdir/GPM-$assembly[2]-$assembly[3]-Chr$chr.svg") or die "can't open file: $tmpdir/GPM-$assembly[2]-$assembly[3]-Chr$chr.svg";
	print SVGFILE $graphic;
	close (SVGFILE);
	`gzip -f $tmpdir/GPM-$assembly[2]-$assembly[3]-Chr$chr.svg`;
			...
			<ul style='z-index: 1000;white-space: nowrap;'>
				<li><a><span class='ui-icon ui-icon-disk'></span>Download</a>
					<ul style='z-index: 1000;white-space: nowrap;'>
						...
						<li><a href='$tempurl/GPM-$assembly[2]-$assembly[3]-Chr$chr.svg.gz' target='hiddenFrame'><span class='ui-icon ui-icon-bullet'></span>SVG</a></li>
					</ul>
				</li>
