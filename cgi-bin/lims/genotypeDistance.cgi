...
open (DISTANCE,">$tmpdir/genotypeDistance.$$.meg") or die "can't open file: $tmpdir/genotypeDistance.$$.meg";
...
close (DISTANCE);
`gzip -f $tmpdir/genotypeDistance.$$.meg`;
...
$( "#dialog" ).dialog( "option", "buttons", [ { text: "Download", click: function() { location.href='$tempurl/genotypeDistance.$$.meg.gz'; } }, { text: "Print", click: function() {printDiv('genotypeDistance$$'); } }, { text: "OK", click: function() {closeDialog(); } } ] );
