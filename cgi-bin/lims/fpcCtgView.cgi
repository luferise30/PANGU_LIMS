...
if ($fpcCtgId)
{
	...
	open (SVGFILE,">$tmpdir/FPC-$fpcCtgList[2]-$fpcCtgList[0].svg") or die "can't open file: $tmpdir/FPC-$fpcCtgList[2]-$fpcCtgList[0].svg";
	print SVGFILE $graphic;
	close (SVGFILE);
	`gzip -f $tmpdir/FPC-$fpcCtgList[2]-$fpcCtgList[0].svg`;
	...
	<ul class='fpcCtgListMenu' style='width: 100px;float: left; margin-right: .3em; white-space: nowrap;'>
		<li><a><span class='ui-icon ui-icon-wrench'></span>You Can</a>
			<ul style='z-index: 1000;white-space: nowrap;'>
				...
				<li><a href='$tempurl/FPC-$fpcCtgList[2]-$fpcCtgList[0].svg.gz' target='hiddenFrame'><span class='ui-icon ui-icon-disk'></span>Download SVG</a></li>
				<li><a>Legends</a>
					<ul>
