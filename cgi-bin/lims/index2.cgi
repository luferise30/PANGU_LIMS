...
# 		if ($getSequences[8] =~ /^>/)
# 		{
# 			my $seqFile = "$tmpdir/$getSequences[0].seq";
# 			open (FILE, ">$seqFile");
...
<link type="image/png" rel="icon" href="$htdocs/favicon.ico" />
<link type="image/x-icon" rel="shortcut icon" href="$htdocs/favicon.ico" />
<link rel="stylesheet" type="text/css" href="$htdocs/css/smoothness/jquery-ui-1.10.4.custom.min.css" />
<link rel="stylesheet" type="text/css" href="$htdocs/css/dataTables.jqueryui.css" />
<link rel="stylesheet" type="text/css" href="$htdocs/css/lims.css" />
<script src="$htdocs/js/jquery-1.10.2.js" type="text/javascript"></script>
<script src="$htdocs/js/jquery-ui-1.10.4.min.js" type="text/javascript"></script>
<script src="$htdocs/js/d3.v3.min.js" type="text/javascript"></script>
<script src="$htdocs/js/newick.js" type="text/javascript"></script>
<script src="$htdocs/js/d3.phylogram.js" type="text/javascript"></script>
<script src="$htdocs/js/jquery.dataTables.min.js" type="text/javascript"></script>
<script src="$htdocs/js/dataTables.jqueryui.js" type="text/javascript"></script>
<script src="$htdocs/js/jquery.ui-contextmenu.min.js" type="text/javascript"></script>
</head>
<body id="top">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td width="15%"><a href="$htdocs"><img src="pangulogo.cgi"/></a></td>
...
<div id='loadingPage' class='ui-state-error ui-corner-all' onclick='loadingHide()'><img src='$htdocs/css/images/loading.gif'> Page is loading...</div>
<div id='savingPage' class='ui-state-highlight ui-corner-all'><img src='$htdocs/css/images/loading.gif'> Saving...</div>
...
<script type="text/javascript">
	...
	{
		$('#'+divname).empty().append("<img src='$htdocs/css/images/loading.gif'>Loading...").load(address);
		return false;
	}
	...
	function openDialog(dialogAddress)
	{
		$('#dialog').dialog({
			...
			{
				$(this).empty();
		        $(this).append("<img src='$htdocs/css/images/loading.gif'>Loading...");
	...
	function printDiv(divId) {
		...
		mywindow.document.write('<link rel="stylesheet" type="text/css" href="$htdocs/css/smoothness/jquery-ui-1.10.4.custom.min.css" /><link rel="stylesheet" type="text/css" href="$htdocs/css/dataTables.jqueryui.css" /><link rel="stylesheet" type="text/css" href="$htdocs/css/lims.css" />');
